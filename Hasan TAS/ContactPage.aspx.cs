...
namespace Hasan_TAS
{
    public partial class ContactPage : System.Web.UI.Page
    {
        ...
        {
            SqlCommand commandAdd = new SqlCommand("Insert into TableContact (ContactMessage, ContactMail, ContactName) values (@pmsg, @pmail, @pname)" , SqlConnectionClas.connection);
